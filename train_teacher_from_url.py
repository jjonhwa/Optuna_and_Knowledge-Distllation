...
if __name__ == "__main__":
    ...
    print("efficientnet url:", model_urls)

    parser = argparse.ArgumentParser(description="Train model.")
    parser.add_argument(
        "--model", default="configs/model/effb0_.yaml", type=str, help="model config",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model_url",
        default="https://www.dropbox.com/s/9wigibun8n260qm/efficientnet-b0-4cfa50.pth?dl=1",
        type=str,
        help="model link",
    )
    ...
    log_dir = os.environ.get("SM_MODEL_DIR", os.path.join("exp", "teacher_url"))
